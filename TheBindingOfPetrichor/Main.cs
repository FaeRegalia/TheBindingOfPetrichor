...
using R2API;
using R2API.Utils;
using TheBindingOfPetrichor.Artifact;
using TheBindingOfPetrichor.Equipment;
using TheBindingOfPetrichor.Equipment.EliteEquipment;
using TheBindingOfPetrichor.Items;
using UnityEngine;

namespace TheBindingOfPetrichor
{
    ...
    {
        public const string ModGuid = "com.FaeRegalia.MyModName";
        public const string ModName = "The Binding of Petrichor";
        ...
        private void Awake()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("TheBindingOfPetrichor.mymodassets"))
            {
